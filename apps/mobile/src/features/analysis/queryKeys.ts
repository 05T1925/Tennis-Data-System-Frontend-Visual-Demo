export const analysisQueryKeys = {
  ...
  results: (userId: string) => [...analysisQueryKeys.all, 'result', userId] as const,
  result: (userId: string, videoId: string) =>
    [...analysisQueryKeys.results(userId), videoId] as const,
};
